    ...
    for (let i = 0; i < count; i++) {
        ...
        jobs[reminderID] = schedule.scheduleJob(reminderID.toString(), scheduled, function () {
            ...
            const mailOptions = {
                ...
                html: 'Hello ' + user.username + ',<br/><br/>This is a reminder for the following event: ' + reminderName + "<br/>Date: " + month + "/" + day + "/" + year + "<br/>Time: " + hours + ":" + minutes + "<br/>Description: " + reminderDescription + "<br/><br/>Thank you for using our friendly reminders. :)"
            }
